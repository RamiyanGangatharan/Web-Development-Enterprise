...
public class User implements CollegeInterface
{
    ...
    public void setPassword(String password) throws InvalidPasswordException, InvalidUserDataException
    {
        if
        (
            !password.isEmpty() &&
     ...
     */
    public User() throws InvalidIdException, InvalidNameException, InvalidPasswordException, InvalidUserDataException
    {
        // Initialization
        setId(DEFAULT_ID);
    ...
    (
        ...
        Date lastAccess, Date enrolDate, boolean enabled, char type
            ...
            throws InvalidIdException, InvalidNameException, InvalidPasswordException, InvalidUserDataException
    {
        // Initialization
        setId(id);
